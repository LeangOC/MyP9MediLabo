...
4. Création répertoire Gateway/javadoc
5. copier le fichier index.html  et le répertoire de Gateway/target/site/apidocs/ vers le répertoire com vers Gateway/javadoc
